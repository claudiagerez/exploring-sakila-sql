...
+------------------------------------------------------+
| AVG(TIMESTAMPDIFF(MINUTE, rental_date, return_date)) |
+------------------------------------------------------+
|                                            7236.4757 |
+------------------------------------------------------+
~~~~
...
The total revenue from __long rentals__ is $42488.77
...
The total revenue from __short rentals__ is $24399.62
